...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2021 at 12:21 PM
...
(23, 'images.jpg', 'Ali obeidat', 'Aliobeidat03@gmail.com', 'asdasd123', '2021-12-06'),
...
(3, 7, 21, 'good', '2021-12-08', 'draft'),
(4, 7, 21, 'Good', '2021-12-08', 'draft'),
(5, 7, 21, 'good', '2021-12-08', 'draft'),
(6, 7, 21, 'good', '2021-12-08', 'public');
...
(5, 7, 'Order Placed', 149, '2021-12-07', 5, 'Amman', 'ffff', 1234567890, ''),
(6, 7, 'Order Placed', 699, '2021-12-07', 14, 'Amman', 'ffff', 1234567890, ''),
(7, 7, 'Order Placed', 72, '2021-12-10', 4, 'Amman', 'ffff', 1234567890, '');
...
(7, '', 'Reem khaled Bani Ali', 'reem.baniali@gmail.com', 'Reem@123', '2021-12-06');
...
--
ALTER TABLE `users_cart`
  MODIFY `user_cart_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
